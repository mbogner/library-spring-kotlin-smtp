...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-smtp")
        property("sonar.projectName", "spring-kotlin-smtp")
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("spring-kotlin-smtp")
                description.set("Mail sending API for Kotlin and Spring Boot.")
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-smtp")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-smtp.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-smtp.git")
                }
                developers {
                    developer {
                        id.set("mbo")
